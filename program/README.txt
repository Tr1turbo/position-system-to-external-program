The documentation for this software is at:
https://alleyway.hai-vr.dev/docs/products/position-system-to-external-program/

The original source code for this software is at:
https://github.com/hai-vr/position-system-to-external-program
(If you did not download this software from https://alleyway.hai-vr.dev/ nor https://github.com/hai-vr/, this may be different)

You can find the licenses of third-party modules in the ThirdParty/ folder.
